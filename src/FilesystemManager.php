...
class FilesystemManager
{
    ...
    public function createLocalDriver(array $config)
    {
        ...
        return $this->adapt($this->createFlysystem(new LocalAdapter(
            Yii::getAlias($config['root']), LOCK_EX, $links, $permissions
        ), $config));
    }
    ...
    {
        return Yii::$app->params['filesystems']['disks'][$name];
    }
    ...
    {
        return Yii::$app->params['filesystems']['default'];
    }
    ...
    {
        return Yii::$app->params['filesystems']['cloud'];
    }
